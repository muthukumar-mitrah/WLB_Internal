...
const getSizeStyles = (size, buttonHeight, spacing) => {
  switch (size) {
    case 'sm':
      return { height: buttonHeight.sm, paddingHorizontal: spacing[4], textVariant: 'buttonSmall' };
    case 'lg':
      return { height: buttonHeight.lg, paddingHorizontal: spacing[8], textVariant: 'buttonLarge' };
    default:
      return { height: buttonHeight.md, paddingHorizontal: spacing[6], textVariant: 'button' };
  }
};
    ...
    <TouchableOpacity
      ...
      {loading ? (
        ...
        <View style={styles.content}>
          ...
          <AppText variant={sizeStyles.textVariant} color={variantStyles.textColor} style={textStyle}>
            {title}
          </AppText>
